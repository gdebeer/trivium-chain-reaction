...
export const BADGE_NAMES: Record<string, string> = {
  ...
  '211': 'Dan Ash',
  '311': 'David Beisel',
  '450': 'Sampriti Bhattacharyya',
  '550': 'Nickhil Bhave',
  '611': 'Anita Broellochs',
  '122': 'Thomas Cesare-Herriau',
  '222': 'Sahil Choudhry',
  '322': "Andrew D'Souza",
  '411': 'Anand Das',
  '511': 'Bryce DeFigueiredo',
  '622': 'Tim Eby',
  '133': 'Jeremy Fischer',
  '233': 'Carlos Gaitan Ospina',
  '333': 'Maxime Germain',
  '422': 'Fynn Glover',
  '522': 'Rob Go',
  '633': 'Amar Goel',
  '144': 'Adrien Guilmineau',
  '244': 'Derek Haswell',
  '344': 'Caleb Hicks',
  '433': 'Lee Hower',
  '533': 'Patrick Ip',
  '644': 'Katie Jaxheimer Agarwal',
  '155': 'John Joe Smith',
  '255': 'Mark Josephson',
  '355': 'Greg Karlin',
  '444': 'Melody Koh',
  ...
  '555': 'Alex McNaughten',
  '616': 'Jason Morrow',
  '127': 'Misha Nasrollahzadeh',
  '227': 'Jackson Nicolas',
  '327': 'Stephanie Palmeri',
  '416': 'Peter Pezaris',
  '516': 'Zsika Phillip',
  '627': 'Carter Powers',
  '138': 'David Reich',
  ...
  '638': 'Xan Tanner',
  '149': 'Chris Taylor',
  '249': 'Amanda Tommasino',
  '349': 'Matthew Vega-Sanz',
  '438': 'Jean-Sébastien Wallez',
  '538': 'Robyn Ward',
  '649': 'Jonathan White',
  '150': 'Justin Whitehead',
};
